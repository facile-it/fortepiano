...
//         ),
//       ).toStrictEqual(
//         pipe(ApplySeq.ap(of(bc), ApplySeq.ap(of(ab), fa)), toReadonlyArray),
//       )
//     })
//   })
...
//       expect(
//         pipe(
//           ApplicativeSeq.ap(ApplicativeSeq.of(ab), ApplicativeSeq.of(a)),
//           toReadonlyArray,
//         ),
//       ).toStrictEqual(pipe(ApplicativeSeq.of(ab(a)), toReadonlyArray))
//     })
//     it('interchange', () => {
//       expect(
//         pipe(
...
//         pipe(
//           ApplicativeSeq.ap(
//             ApplicativeSeq.of((ab: (a: number) => number) => ab(a)),
//             ApplicativeSeq.of(ab),
//           ),
//           toReadonlyArray,
//         ),
//       )
