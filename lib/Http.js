...
exports.mock = exports.got = exports.fetch = exports.axios = exports.log = exports.pool = exports.cache = exports.json = exports.HttpErrorC = exports.HttpResponseC = void 0;
...
const Got_1 = require("./http/Got");
Object.defineProperty(exports, "got", { enumerable: true, get: function () { return Got_1.got; } });
...
exports.pool = pool;
const _log = (method, request, log) => (url, options) => $R.salt(TE.MonadIO)(R.randomInt(0, Number.MAX_SAFE_INTEGER), (salt) => function_1.pipe(log.start(`[${salt}] \r${$Stri.uppercase(method)} ${url}`), TE.fromIO, TE.chain(() => request(url, options)), TE.chainFirstIOK(() => log.end(`[${salt}] \r${$Stri.uppercase(method)} ${url}`)), TE.orElseW((error) => function_1.pipe(log.end(`[${salt}] \r${$Stri.uppercase(method)} ${url}`), TE.fromIO, TE.chain(() => TE.left(error))))));
