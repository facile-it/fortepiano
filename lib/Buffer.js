...
exports.fromStream = exports.BufferFromStringC = exports.BufferC = void 0;
const t = __importStar(require("io-ts"));
const $E = __importStar(require("./Error"));
const $TE = __importStar(require("./TaskEither"));
const is = (u) => u instanceof Buffer;
exports.BufferC = new t.Type('Buffer', is, (u, c) => (is(u) ? t.success(u) : t.failure(u, c)), (b) => b.toString('base64'));
...
}, exports.BufferC.encode);
const fromStream = (stream) => $TE.tryCatch(() => new Promise((resolve, reject) => {
    const buffer = [];
    stream
        .on('error', reject)
