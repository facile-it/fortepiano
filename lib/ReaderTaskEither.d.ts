...
export declare const picksOptionK: <R extends object>() => <E>(onNone: Lazy<E>) => <K extends keyof R, B>(k: K, f: (r: Pick<R, K>[K]) => O.Option<B>) => RTE.ReaderTaskEither<Pick<R, K>, E, B>;
